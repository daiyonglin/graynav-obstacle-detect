...
$YoloWeights = "E:\jichuang\yolov8n.pt"
$E3Checkpoint = "E:\jichuang\graynav_surface_depth_final_selection_e3_epoch49_inspect\final_selection_e3_epoch49\checkpoints\e3_epoch49_best_seg.pt"
...
try {
    $arguments = @(
        "scripts\train_graynav_unified_indoor.py",
        "--coco", $CocoPrepared,
        "--scene", $ScenePrepared,
