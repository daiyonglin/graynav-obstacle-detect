...
export A1_VOICE_FAULT_REPEAT_MS="${A1_VOICE_FAULT_REPEAT_MS:-3000}"
export A1_VOICE_FAULT_HOLD_MS="${A1_VOICE_FAULT_HOLD_MS:-1800}"
...
export A1_ADAPTIVE_GRAY_DARK_MEAN="${A1_ADAPTIVE_GRAY_DARK_MEAN:-70}"
