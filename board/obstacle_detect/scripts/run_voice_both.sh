...
export A1_VOICE_FAULT_REPEAT_MS="${A1_VOICE_FAULT_REPEAT_MS:-2000}"
export A1_VOICE_FAULT_HOLD_MS="${A1_VOICE_FAULT_HOLD_MS:-200}"
...
export A1_VOICE_ACK="${A1_VOICE_ACK:-1}"
export A1_VOICE_REQUIRE_ACK="${A1_VOICE_REQUIRE_ACK:-1}"
export A1_VOICE_QUERY_IDLE="${A1_VOICE_QUERY_IDLE:-1}"
...
export A1_VOICE_BYTE_GAP_US="${A1_VOICE_BYTE_GAP_US:-500}"
export A1_VOICE_POST_TX_DELAY_MS="${A1_VOICE_POST_TX_DELAY_MS:-15}"
...
export A1_VOICE_SOFT_RESET_EVERY_TX="${A1_VOICE_SOFT_RESET_EVERY_TX:-0}"
...
export A1_VOICE_RETRY="${A1_VOICE_RETRY:-1}"
