...
export A1_VOICE_NO_RX_RECOVER="${A1_VOICE_NO_RX_RECOVER:-3}"
...
export A1_DEBUG_POSTPROCESS="${A1_DEBUG_POSTPROCESS:-1}"
export A1_DEBUG_POSTPROCESS_INTERVAL="${A1_DEBUG_POSTPROCESS_INTERVAL:-60}"
export A1_OUTPUT_SERIAL_DIAG="${A1_OUTPUT_SERIAL_DIAG:-1}"
