...
export A1_VOICE_STOP_FOLLOWUP_HOLD_MS="${A1_VOICE_STOP_FOLLOWUP_HOLD_MS:-2500}"
export A1_VOICE_TURN_FOLLOWUP_HOLD_MS="${A1_VOICE_TURN_FOLLOWUP_HOLD_MS:-1500}"
...
export A1_RANGE_URGENT_M="${A1_RANGE_URGENT_M:-0.60}"
export A1_RANGE_NEAR_M="${A1_RANGE_NEAR_M:-0.80}"
export A1_RANGE_WARNING_M="${A1_RANGE_WARNING_M:-1.50}"
